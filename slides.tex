...
\begin{itemize}
  ...
  \begin{itemize}
    \item Machine translation \citep{birch2016hume,xu-etal-2020-incorporate}
    \item Text simplification \citep{sulem2018samsa}
    \item Grammatical error correction \citep{choshen2018usim}
  \end{itemize}
  \item Sentence splitting for text simplification \citep{sulem2018simple,sulem-etal-2020-semantic}.
\end{itemize}
