...
\begin{enumerate}
  \item Match terminal yield of primary edges.
...
\begin{adjustbox}{frame,scale=.55,center}
    \begin{tikzpicture}[level distance=12mm, sibling distance=19mm, ->, thick,
      ...
      \node (ROOT) at (0,0) [circle] {}
        ...
        {
          child {node (Daniel) [word] {Daniel} edge from parent node[midway, fill=white] {A}}
          child[red] {node [word] {moved} edge from parent node[midway, fill=white] {P}}
          child {node [circle] {}
          {
...
\begin{enumerate}
  \item Match terminal yield \textbf{+ label} of primary edges.
  \item Calculate \textbf{precision, recall and F1} scores.
  \item Repeat for remote edges.
\end{enumerate}
...
\begin{minipage}{.5\textwidth}
    ...
    \begin{enumerate}
        ...
        \item Unary children
        \item Nested Centers
        \item Attachment of common Functions
    \end{enumerate}
\end{minipage}
\begin{minipage}{.45\textwidth}
\begin{adjustbox}{frame,scale=.55,center}
